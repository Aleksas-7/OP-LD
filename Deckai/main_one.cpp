  ...
  do {
    ...
    else if (pasirinkimas == 'p')
    {
      ...
      try {
        ...
        studentu_padalinimas(nuskraiustukai, galvociai, stud_kiek);
      ...
      for (int i = 0 ; i < 5 ; i++){
        ...
        deque<studentas> galvociai, nuskriaustukai;
        //galvociai.reserve(stud_kiek);
        //nuskriaustukai.reserve(stud_kiek);
        std::deque<studentas>::iterator it;
        it = std::find_if(st.begin(), st.end(),  findGalvocius);
        copy(it, st.end(), std::back_inserter(galvociai));
        copy(st.begin(), it, std::back_inserter(nuskriaustukai));
        //st.clear();
